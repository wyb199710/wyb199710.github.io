...
(function($){
	var posterMovieGrid = function(option){
		...
		var fn = function() {
            var h1 = document.documentElement ? document.documentElement.clientHeight : document.body.clientHeight;
            $(".posterMovieGrid").css("height", h1 + "px");
		...
		paging: function(){
			...
			group.className = 'page';
				...
				for(var i=0; i<this.total; i++){
					...
					itemStr += '<div class="item_img" style="background:url('+data.img+');background-size:cover;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+data.img+'\',sizingMethod=\'scale\');"></div>';
